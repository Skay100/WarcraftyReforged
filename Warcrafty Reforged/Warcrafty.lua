...
function WarcraftyOnEvent(self, event, ...)
	...
	elseif ( event == "UNIT_HAPPINESS" ) then
		...
		if ( happiness == 1 ) then
			WarcraftyPetFrameHappinessTexture:Show()
			WarcraftyPetFrameHappinessTexture:SetTexCoord(0.375, 0.5625, 0, 0.359375);
		elseif ( happiness == 2 ) then
			WarcraftyPetFrameHappinessTexture:Show()
			WarcraftyPetFrameHappinessTexture:SetTexCoord(0.1875, 0.375, 0, 0.359375);
		elseif ( happiness == 3 ) then
			WarcraftyPetFrameHappinessTexture:Show()
			WarcraftyPetFrameHappinessTexture:SetTexCoord(0, 0.1875, 0, 0.359375);
		else
			WarcraftyPetFrameHappinessTexture:Hide()
		end
